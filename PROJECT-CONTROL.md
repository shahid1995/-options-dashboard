...
> Entry point: [`AI.md`](AI.md) · Runtime topology: [`AI.md` §3](AI.md) ·
...
Hermes / FreeBuff should treat the GitHub Issue as the execution contract. The
full operating rules — including anti-context-drift guards — live in
[`AGENTS.md`](AGENTS.md); the summary:
...
The repository contains a substantial historical engineering record under:

`options-dashboard-project/docs/`

The current status snapshot is maintained at:

`options-dashboard-project/docs/superpowers/STRIKENOVA_IMPLEMENTATION_STATUS.md`

(governed by `options-dashboard-project/docs/superpowers/STRIKENOVA_EXECUTION_PROTOCOL.md`)
