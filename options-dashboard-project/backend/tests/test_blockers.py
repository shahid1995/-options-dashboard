...
class TestMigrationBackfillSemantics:
    def test_migration_file_does_not_set_trading_active(self):
        p = pathlib.Path("alembic/versions/f7a3c2d1e94b_add_capability_separation_columns.py")
        content = p.read_text(encoding="utf-8")
        assert "trading_status = 'active'" not in content
