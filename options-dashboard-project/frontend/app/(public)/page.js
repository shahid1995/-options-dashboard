...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <RiskFirstSection />
      <Section style={{ background: COLOR.baseElevated, borderTop: `1px solid ${COLOR.border}`, borderBottom: `1px solid ${COLOR.border}` }}>
        <Container maxWidth={1100}><SectionTitle eyebrow="PAPER EXECUTION" title="Practice the workflow. Not your capital." subtitle="Decision, simulation, position management, P&L and review in one environment." /><WorkflowTabs steps={paperSteps} defaultStep="decision" ariaLabel="Paper Trading" /><div style={{ textAlign: "center", marginTop: SPACE.section }}><LinkButton variant="secondary" size="md" href="/paper-trading" className="ds-focus-ring">Explore Paper Trading <span aria-hidden="true">→</span></LinkButton></div></Container>
      </Section>
