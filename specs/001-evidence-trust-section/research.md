...
| SC-001 placement clarification | SC-001 refers to the overall Home page first-impression experience, not the Evidence & Trust section itself. The existing Hero is the primary first-impression mechanism. | The Evidence & Trust section is placed after Section 04; it cannot be the primary 10-second mechanism. The Hero already serves this purpose. |
